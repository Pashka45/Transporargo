...
class SearchFormSelectPlaceFragment : BaseSelectPlaceMapFragment() {

    private val viewModel: SearchViewModel by activityViewModels()
    private lateinit var binding: FragmentSearchFormSelectPlaceBinding

    override fun onMapReadyCallback() {
        val args = SearchFormSelectPlaceFragmentArgs.fromBundle(requireArguments())
    ...
    override fun onCreateView(
        ...
        binding = FragmentSearchFormSelectPlaceBinding.inflate(inflater)
        ...
        binding.saveBtn.setOnClickListener {
            ...
            findNavController().navigate(
                SearchFormSelectPlaceFragmentDirections.actionSearchFormSelectPlaceFragmentToSearchFragment()
            )
        }
