...
class MyRequestsAdapter(private val listener: MyRequestsListener) :
    ...
    class ViewHolder(private val binding: MyRequestListItemBinding) :
        RecyclerView.ViewHolder(binding.root) {

        val TAG = "MyRequestsAdapter"

        fun bind(item: Request, listener: MyRequestsListener) {
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = MyRequestListItemBinding.inflate(layoutInflater, parent, false)
    ...
    data class RequestListItem(
        ...
        val phone: String,
        val listener: MyRequestsListener
    )
}